...
function RoleItem({role}) {
  ...
  switch(role.id){
    case "3b66d950-c972-42b7-a62a-05bcca8b57cf":
      roleStyle ="from-yellow-400 to-orange-300";
      break;
    case "d8088721-09e9-4596-8393-09677981b42c":
      roleStyle ="from-red-500 to-red-300";
      break;
    ...
    case "0160b93a-f1c0-482c-9c2f-9ef5964ce225":
      roleStyle ="from-green-500 to-green-300 ";
      break;
    case "9853d725-4467-4869-a6d6-c270512dc6f8":
      roleStyle ="from-blue-500 to-blue-300";
      break;
  }
  return (
    <div className={"RoleItem text-white bg-gradient-to-r "+roleStyle+" rounded-lg  flex items-center justify-center box-border px-2 py-1"}>
        <p>{role.name}</p>
    </div>
  )
}
